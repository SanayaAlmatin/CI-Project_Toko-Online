	...
	<div class="carousel-inner">
		...
		<div class="carousel-item <?php echo $key==0 ? "active" : "" ?>">
			<img src="<?php echo $this->config->item("url_slider").$value["foto_slider"] ?>" class="d-block w-100"
				alt="foto slider" height="500px">
			<div class="carousel-caption d-none d-md-block text-black">
				<h5>Banner <?php echo $key+1 ?></h5>
				<p><?php echo $this->config->item("slider").$value["caption_slider"] ?></p>
			</div>
		</div>
		<?php endforeach?>
					...
					<div class="card mb-3 border-0 shadow">
						<div class="card-body text-center">
							...
							<img src="<?php echo $this->config->item("url_produk").$value["foto_produk"] ?>"
								class="pe-4" width="250px" height="250px">
							<div class="mt-3">
...
<section class="bg-white py-5">
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-3">
				<img src="<?php echo $this->config->item("url_artikel").$value["foto_artikel"] ?>" width="250px"
					height="250px">
